...
<<<<<<< HEAD
                <p style="font-size: 19px;font-family: 'Harmattan', sans-serif;text-align:justify;">
                    Congratulations on your upcoming wedding! We are delighted to be part of your plan. Look through our unique wedding cakes for your choice or should you need a guidance on what flavours, design and size to make, contact us to discuss your desired options. We are happy to make your special day great!
                </p>
=======
                ...
                <div class="row product_item_inner">
                    ...
                    <div class="col-lg-4 col-md-4 col-6">
                        <div class="cake_feature_item">
                            ...
                            <div class="cake_text">
<<<<<<< HEAD
                                <h3 style="font-size: 14px;font-weight:bolder;text-transform:capitalize">{{ $prodcat->name }}</h3>
=======
