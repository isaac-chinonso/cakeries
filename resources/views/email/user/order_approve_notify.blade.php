                                                                ...
                                                                <td>
                                                                    <div class="contentEditableContainer contentTextEditable">
                                                                        <div class="contentEditable">
                                                                            <h2 align="center">Order Approval</h2>
                                                                            <br>
                                                                            <p style="font-size: 14px;font-family: 'Harmattan', sans-serif;text-align:justify;">
                                                                                <strong>
                                                                                    Hello {{ $orderapproval->user->profile->first()->lname }} {{ $orderapproval->user->profile->first()->fname }}, </strong><br>
                                                                                Your Order has been recieved and approved by <a href="https://www.cakeries.co.uk" target="_blank">Cakeries</a>, We will get in touch with you shortly
                                                                                <br>
                                                                            </p>
                                                                        </div>
                                                                    </div>
