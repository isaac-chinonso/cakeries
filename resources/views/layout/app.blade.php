...
<body class="fix-header card-no-border logo-center">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> 
                            <a class="has-arrow waves-effect waves-dark" href="#"><i class="mdi mdi-monitor"></i><span class="hide-menu">Dashboard</span></a>
                        </li>
                        <li> 
                            <a class="has-arrow waves-effect waves-dark" href="#"><i class="mdi mdi-cards"></i><span class="hide-menu">Categories</span></a>
                        </li>
                        <li class="three-column"> 
                            <a class="has-arrow waves-effect waves-dark" href="#"><i class="mdi mdi-cake-variant"></i><span class="hide-menu">Products</span></a>    
                        </li>
                        <li class="two-column"> 
                            <a class="has-arrow waves-effect waves-dark" href="#"><i class="mdi mdi-cart"></i><span class="hide-menu">Orders</span></a>
                        </li>
                        <li class="two-column"> 
                            <a class="has-arrow waves-effect waves-dark" href="#"><i class="mdi mdi-account-multiple"></i><span class="hide-menu">Users</span></a>
                        </li>
                    </ul>
                </nav>
    ...
    <script src="../app/plugins/bootstrap/js/popper.min.html"></script>
    ...
    <!-- Style switcher -->
    <!-- ============================================================== -->
    <script src="../app/plugins/styleswitcher/jQuery.style.switcher.js"></script>
</body>
